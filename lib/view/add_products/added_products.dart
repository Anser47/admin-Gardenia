...
import 'package:admin_gardenia/view/add_products/editing_screen.dart';
import 'package:admin_gardenia/view/add_products/product_discription.dart';
...
class _AddProductCardState extends State<AddProductCard> {
  ...
  void initState() {
    super.initState();
    // Parse the price when the widget is created
